...
| `testflight-internal-testing`            | Whether this build is for TestFlight internal testing. If true, uploads to App Store Connect and skips waiting for processing. (ios)                                                                                | No       | `"false"`                           |
