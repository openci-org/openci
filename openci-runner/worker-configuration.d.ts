/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9c2b8b4030f1a67c4347ee027d006d0e)
// Runtime types generated with workerd@1.20251210.0 2025-12-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		OPENCI_RUNNER_LABEL: "openci-runner-beta-dev" | "openci-runner-beta";
		...
		REGISTER_RUNNER: Workflow<Parameters<import("./src/index").RegisterRunner['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENCI_RUNNER_LABEL" | "OPENCI_RUNNER_BASE_IMAGE" | "ENVIRONMENT" | "INCUS_SERVER_URL" | "CF_ACCESS_CLIENT_ID" | "CF_ACCESS_CLIENT_SECRET" | "GH_APP_ID" | "GH_APP_WEBHOOK_SECRET" | "GH_APP_PRIVATE_KEY" | "SENTRY_DSN" | "SLACK_WEBHOOK_URL">> {}
}
