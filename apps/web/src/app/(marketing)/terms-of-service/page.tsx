        ...
        <div className="mx-auto mt-16 mb-32 max-w-xl space-y-12">
            ...
            <dd className="mt-4 text-sm/6 text-gray-600">
              ...
              <ul className="mt-2 ml-4 list-disc space-y-1">
                <li>
                  ...
                  unless canceled at least 24 hours before the end of the
                  current period.
                </li>
                <li>
                  <strong>Billing:</strong> Payment will be charged to your
                  Apple ID account at confirmation of purchase. Your account
                  will be charged for renewal within 24 hours prior to the end
                  of the current period.
                </li>
                <li>
                  <strong>Cancellation:</strong> You can cancel your
                  subscription at any time through your Apple ID account
                  settings. Cancellation takes effect at the end of the current
                  billing period. No partial refunds are provided for the
                  remaining period.
                </li>
                <li>
                  <strong>Free Trials:</strong> If a free trial is offered, any
                  unused portion of the trial period will be forfeited when you
                  purchase a subscription.
                </li>
                <li>
                  <strong>Price Changes:</strong> We reserve the right to modify
                  pricing with reasonable notice. Price changes will take effect
                  at the start of the next subscription period following the
          ...
          <dl>
            ...
            <dd className="mt-4 text-sm/6 text-gray-600">
              ...
              applicable law. Since subscriptions are managed through Apple, all
              refund requests must be submitted through Apple&apos;s support
          ...
          <dl>
            ...
            <dd className="mt-4 text-sm/6 text-gray-600">
              ...
              Termination of your account does not automatically cancel your
              subscription. You must cancel your subscription through your Apple
              ID account settings before or after termination to avoid further
              charges.
            </dd>
          </dl>
          <dl>
