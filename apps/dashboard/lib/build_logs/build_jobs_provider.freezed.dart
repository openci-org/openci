...
@useResult
$Res call({
 String id, String status, String owner, String repo, String? teamId, String? workflowId, String? workflowName, String? workflowFileName, String? commitSha, int? pullRequestNumber, int? runCount, String? latestRunId, String? tagName, String? branch, String? jobKey, String? workflowRunId, List<String>? needs, String? failureSummary, String? failureSummaryModel, Map<String, dynamic>? failureSummaries,@DateTimeConverter() DateTime createdAt,@DateTimeConverter() DateTime updatedAt,@DateTimeConverter() DateTime? completedAt
});
...
/// Create a copy of BuildJob
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? status = null,Object? owner = null,Object? repo = null,Object? teamId = freezed,Object? workflowId = freezed,Object? workflowName = freezed,Object? workflowFileName = freezed,Object? commitSha = freezed,Object? pullRequestNumber = freezed,Object? runCount = freezed,Object? latestRunId = freezed,Object? tagName = freezed,Object? branch = freezed,Object? jobKey = freezed,Object? workflowRunId = freezed,Object? needs = freezed,Object? failureSummary = freezed,Object? failureSummaryModel = freezed,Object? failureSummaries = freezed,Object? createdAt = null,Object? updatedAt = null,Object? completedAt = freezed,}) {
...
as String?,failureSummaries: freezed == failureSummaries ? _self.failureSummaries : failureSummaries // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _BuildJob() when $default != null:
return $default(_that.id,_that.status,_that.owner,_that.repo,_that.teamId,_that.workflowId,_that.workflowName,_that.workflowFileName,_that.commitSha,_that.pullRequestNumber,_that.runCount,_that.latestRunId,_that.tagName,_that.branch,_that.jobKey,_that.workflowRunId,_that.needs,_that.failureSummary,_that.failureSummaryModel,_that.failureSummaries,_that.createdAt,_that.updatedAt,_that.completedAt);case _:
  return orElse();
...
@override final  String? failureSummaryModel;
 final  Map<String, dynamic>? _failureSummaries;
@override Map<String, dynamic>? get failureSummaries {
  final value = _failureSummaries;
  if (value == null) return null;
  if (_failureSummaries is EqualUnmodifiableMapView) return _failureSummaries;
  // ignore: implicit_dynamic_type
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BuildJob&&(identical(other.id, id) || other.id == id)&&(identical(other.status, status) || other.status == status)&&(identical(other.owner, owner) || other.owner == owner)&&(identical(other.repo, repo) || other.repo == repo)&&(identical(other.teamId, teamId) || other.teamId == teamId)&&(identical(other.workflowId, workflowId) || other.workflowId == workflowId)&&(identical(other.workflowName, workflowName) || other.workflowName == workflowName)&&(identical(other.workflowFileName, workflowFileName) || other.workflowFileName == workflowFileName)&&(identical(other.commitSha, commitSha) || other.commitSha == commitSha)&&(identical(other.pullRequestNumber, pullRequestNumber) || other.pullRequestNumber == pullRequestNumber)&&(identical(other.runCount, runCount) || other.runCount == runCount)&&(identical(other.latestRunId, latestRunId) || other.latestRunId == latestRunId)&&(identical(other.tagName, tagName) || other.tagName == tagName)&&(identical(other.branch, branch) || other.branch == branch)&&(identical(other.jobKey, jobKey) || other.jobKey == jobKey)&&(identical(other.workflowRunId, workflowRunId) || other.workflowRunId == workflowRunId)&&const DeepCollectionEquality().equals(other._needs, _needs)&&(identical(other.failureSummary, failureSummary) || other.failureSummary == failureSummary)&&(identical(other.failureSummaryModel, failureSummaryModel) || other.failureSummaryModel == failureSummaryModel)&&const DeepCollectionEquality().equals(other._failureSummaries, _failureSummaries)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.completedAt, completedAt) || other.completedAt == completedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,owner,repo,teamId,workflowId,workflowName,workflowFileName,commitSha,pullRequestNumber,runCount,latestRunId,tagName,branch,jobKey,workflowRunId,const DeepCollectionEquality().hash(_needs),failureSummary,failureSummaryModel,const DeepCollectionEquality().hash(_failureSummaries),createdAt,updatedAt,completedAt]);
...
/// Create a copy of BuildJob
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? status = null,Object? owner = null,Object? repo = null,Object? teamId = freezed,Object? workflowId = freezed,Object? workflowName = freezed,Object? workflowFileName = freezed,Object? commitSha = freezed,Object? pullRequestNumber = freezed,Object? runCount = freezed,Object? latestRunId = freezed,Object? tagName = freezed,Object? branch = freezed,Object? jobKey = freezed,Object? workflowRunId = freezed,Object? needs = freezed,Object? failureSummary = freezed,Object? failureSummaryModel = freezed,Object? failureSummaries = freezed,Object? createdAt = null,Object? updatedAt = null,Object? completedAt = freezed,}) {
...
as List<String>?,failureSummary: freezed == failureSummary ? _self.failureSummary : failureSummary // ignore: cast_nullable_to_non_nullable
as String?,failureSummaryModel: freezed == failureSummaryModel ? _self.failureSummaryModel : failureSummaryModel // ignore: cast_nullable_to_non_nullable
as String?,failureSummaries: freezed == failureSummaries ? _self._failureSummaries : failureSummaries // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,updatedAt: null == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,completedAt: freezed == completedAt ? _self.completedAt : completedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
