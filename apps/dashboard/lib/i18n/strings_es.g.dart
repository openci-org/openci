...
class _TranslationsNavEs implements TranslationsNavEn {
	...
	// Translations
	@override String get workflows => 'Configuración CI/CD';
...
class _TranslationsWorkflowEs implements TranslationsWorkflowEn {
	...
	// Translations
	@override String get title => 'Configuración CI/CD';
	@override String get tabWorkflows => 'Configuración CI/CD';
	@override String get tabRuns => 'Registros CI/CD';
	@override String get addWorkflow => 'Crear configuración CI/CD';
	...
	@override String get selectRepoHint => 'Elige un repositorio de GitHub para gestionar la configuración CI/CD.';
	...
	@override String get selectRepositoryHint => 'Elige un repositorio de GitHub para gestionar la configuración CI/CD.';
...
class _TranslationsWorkflowEditorEs implements TranslationsWorkflowEditorEn {
	...
	// Translations
	@override String get createTitle => 'Crear configuración CI/CD';
	@override String get editTitle => 'Editar configuración CI/CD';
...
class _TranslationsBuildLogsDetailEs implements TranslationsBuildLogsDetailEn {
	...
	@override String get aiFixTitle => 'Preparar una corrección CI/CD';
	@override String get aiFixDescription => 'Usa los registros fallidos y la configuración CI/CD para preparar una rama de corrección o un pull request.';
	@override String get aiFixButton => 'Solicitar corrección';
	@override String get aiFixDialogTitle => 'Entrada para corregir CI/CD';
	@override String get aiFixDialogBody => 'Esto inspeccionará este registro de ejecución, identificará la causa del fallo y propondrá cambios en la configuración CI/CD. El siguiente paso puede conectar la recopilación de registros, la lectura de archivos de configuración y la creación del PR de corrección.';
	@override String get aiFixDialogPrimary => 'Próximamente';
}
...
class _TranslationsSettingsAiFeaturesEs implements TranslationsSettingsAiFeaturesEn {
	...
	@override String get subtitle => 'Habilitar funciones impulsadas por IA como los resúmenes de fallos';
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'nav.workflows' => 'Configuración CI/CD',
			...
			'workflow.title' => 'Configuración CI/CD',
			'workflow.tabWorkflows' => 'Configuración CI/CD',
			'workflow.tabRuns' => 'Registros CI/CD',
			'workflow.addWorkflow' => 'Crear configuración CI/CD',
			...
			'workflow.selectRepoHint' => 'Elige un repositorio de GitHub para gestionar la configuración CI/CD.',
			...
			'workflow.selectRepositoryHint' => 'Elige un repositorio de GitHub para gestionar la configuración CI/CD.',
			...
			'workflow.editor.createTitle' => 'Crear configuración CI/CD',
			'workflow.editor.editTitle' => 'Editar configuración CI/CD',
			...
			'buildLogs.detail.aiFixTitle' => 'Preparar una corrección CI/CD',
			'buildLogs.detail.aiFixDescription' => 'Usa los registros fallidos y la configuración CI/CD para preparar una rama de corrección o un pull request.',
			'buildLogs.detail.aiFixButton' => 'Solicitar corrección',
			'buildLogs.detail.aiFixDialogTitle' => 'Entrada para corregir CI/CD',
			'buildLogs.detail.aiFixDialogBody' => 'Esto inspeccionará este registro de ejecución, identificará la causa del fallo y propondrá cambios en la configuración CI/CD. El siguiente paso puede conectar la recopilación de registros, la lectura de archivos de configuración y la creación del PR de corrección.',
			'buildLogs.detail.aiFixDialogPrimary' => 'Próximamente',
			...
			'settings.aiFeatures.subtitle' => 'Habilitar funciones impulsadas por IA como los resúmenes de fallos',
