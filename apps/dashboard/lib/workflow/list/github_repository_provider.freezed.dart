...
@override
String toString() {
  return 'GitHubRepo(fullName: $fullName, name: $name, owner: $owner, private: $private, defaultBranch: $defaultBranch)';
}
...
class _GitHubRepo implements GitHubRepo {
  const _GitHubRepo({required this.fullName, required this.name, required this.owner, required this.private, required this.defaultBranch});
