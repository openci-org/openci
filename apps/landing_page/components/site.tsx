...
const cicdPricing = {
  en: [
    ...
    },
    {
      ...
      features: ['4 vCPU / 8GB RAM', 'Native iOS / macOS builds', 'Up to 90% cheaper than GitHub Actions'],
    },
    {
      icon: <TerminalIcon />,
      name: 'Linux',
  ...
  ja: [
    ...
    },
    {
      ...
      features: ['4 vCPU / 8GB RAM', 'iOS / macOS ネイティブビルド', 'GitHub Actionsより最大90%オフ'],
    },
    {
      icon: <TerminalIcon />,
      name: 'Linux',
      ...
      <main className="grow">
        <section className="py-16 text-center sm:pt-24">
          <div className={cicdContainerClass}>
            ...
            <p className="mx-auto mt-4 max-w-[42ch] text-pretty text-[1.0625rem] text-neutral-600">{copy.heroDescription}</p>
            <div className="mt-8 flex justify-center">
              <a href={dashboardUrl} target="_blank" rel="noopener noreferrer" className={primaryButtonClass}>
                {copy.heroCta}
              </a>
            </div>
          </div>
        ...
        <section className="py-8">
          <div className={cicdContainerClass}>
            <div className="overflow-hidden rounded-xl border border-neutral-950/8">
              <video autoPlay muted loop playsInline preload="metadata" aria-label={copy.demoLabel} className="w-full">
        ...
        <section id="pricing" className="border-t border-neutral-950/6 py-16">
          <div className={cicdContainerClass}>
            <h2 className="mx-auto max-w-[35ch] text-balance text-center text-[1.75rem] font-medium tracking-tight text-neutral-950">{copy.pricingTitle}</h2>
            <p className="mx-auto mt-2 max-w-[56ch] text-pretty text-center text-base text-neutral-600">{copy.pricingSubtitle}</p>
        ...
        <section className="py-16">
          <div className={cicdContainerClass}>
            <div className="rounded-2xl border border-neutral-950/6 bg-neutral-50 p-8 text-center sm:p-12">
              ...
              <h2 className="mx-auto max-w-[35ch] text-balance text-2xl font-medium tracking-tight text-neutral-950">{copy.supportTitle}</h2>
              <p className="mx-auto mt-3 max-w-[48ch] text-pretty text-base text-neutral-600">{copy.supportDescription}</p>
              <div className="mt-6">
                <a href="https://cal.com/masahiro-aoki-r4rxdx/15min" target="_blank" rel="noopener noreferrer" className={secondaryButtonClass}>
                  {copy.supportCta}
                </a>
              </div>
            </div>
      ...
      <footer className="border-t border-neutral-950/6 py-8">
        <div className={cicdContainerClass}>
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <a href={copy.homeHref} className="text-[1.0625rem] font-semibold tracking-tight text-neutral-950">
              OpenCI
            </a>
            <nav className="flex flex-wrap justify-center gap-6" aria-label="Footer navigation">
              <a href={githubUrl} target="_blank" rel="noopener noreferrer" className="text-sm font-normal text-neutral-500 transition-colors hover:text-neutral-950">
                GitHub
              </a>
              <a href="/studio/" className="text-sm font-normal text-neutral-500 transition-colors hover:text-neutral-950">
                OpenCI Studio
              </a>
              <a href="https://x.com/ma_freud" target="_blank" rel="noopener noreferrer" className="text-sm font-normal text-neutral-500 transition-colors hover:text-neutral-950">
                X / Twitter
              </a>
            </nav>
          </div>
          <p className="mt-6 text-center text-[0.8125rem] text-neutral-400">© OpenCI, Inc. {new Date().getFullYear()}</p>
        </div>
      </footer>
    </div>
  );
  ...
  return (
    <article className="bg-white p-7">
      ...
      <div className="mt-3 tabular-nums">
        ...
        {unit ? <span className="text-[0.8125rem] font-normal text-neutral-500">{unit}</span> : null}
      </div>
...
const services = [
  ...
  {
    title: 'CI/CDの導入支援',
    description: 'お客様のプロジェクトに、CI/CDを導入し、ビルド、テスト、リリースを自動化します。また、各種テストコードの追加も必要に応じて行います。',
  },
  {
...
const clients = [
  ...
  },
  {
    ...
    description: '大手芸能プロダクションと連携し、著名アーティストのファン向けチケットシステムの技術顧問を担当。設計レビューに加え、一部開発にも携わっています。',
  },
  {
    label: '技術顧問',
    title: 'ヘルスケア系スタートアップ',
    description: 'パーソナルコーチング領域のモバイルアプリケーション開発における技術顧問。アーキテクチャ設計やUI/UX改善のアドバイスを提供しています。',
  },
];
...
const studioPricing = [
  ...
  },
  {
    ...
    features: ['柔軟にご要望にお応え可能', 'アプリ以外の開発', 'AI開発の技術支援', 'CI/CDの導入支援', 'テストコードの追加'],
    featured: true,
  },
];
  ...
  return (
    <section className="py-16 sm:py-28">
      <div className={containerClass}>
        ...
        <div className="mt-7">
          <a href={formUrl} target="_blank" rel="noopener noreferrer" className={primaryButtonClass}>
            お問い合わせ
          </a>
        </div>
      </div>
...
function StudioServices() {
  return (
    <section className="border-t border-neutral-950/6 py-20">
      <div className={containerClass}>
        <SectionIntro eyebrow="提供サービス" title="個人開発規模から大規模まで、なんでもお任せください。">
        ...
        <dl className="mt-10 grid overflow-hidden rounded-2xl border border-neutral-950/6 bg-neutral-950/6 sm:grid-cols-2 sm:gap-px">
          {services.map((service) => (
            <div key={service.title} className="bg-white p-7">
              <dt className="text-base font-semibold tracking-tight text-neutral-950">{service.title}</dt>
              <dd className="mt-2.5 text-pretty text-sm/7 text-neutral-600">{service.description}</dd>
            </div>
          ))}
        </dl>
      </div>
...
function StudioTestimonial() {
  return (
    <section className="border-t border-neutral-950/6 py-20">
      <div className={containerClass}>
        <figure>
          <blockquote className="relative max-w-[40ch] text-pretty text-2xl font-normal italic tracking-tight text-neutral-950 before:absolute before:inline before:-translate-x-full before:content-['\201C'] after:inline after:content-['\201D'] sm:text-[1.625rem]">
            <p>OpenCI Studioのサポートにより、停滞していたプロジェクトが劇的に改善しました。技術的な課題の解決だけでなく、チーム全体のスキルアップを実現し、メンバーのモチベーション向上にも大きく貢献していただきました。</p>
          </blockquote>
          <figcaption className="mt-5 text-sm text-neutral-500">— 非公開プロジェクト(大手外資系企業) · 技術顧問として参画</figcaption>
        </figure>
      </div>
    </section>
  );
    ...
    <section className="border-t border-neutral-950/6 py-20">
      <div className={containerClass}>
        ...
        <div className="mt-10 grid overflow-hidden rounded-2xl border border-neutral-950/6 bg-neutral-950/6 sm:grid-cols-2 sm:gap-px">
          {clients.map((client) => (
            <article key={client.title} className={`bg-white p-7 transition-colors hover:bg-neutral-50 ${client.longTerm ? 'border-l-3 border-neutral-950' : ''}`}>
              <div className="mb-3 inline-flex rounded-full bg-neutral-100 px-2.5 py-1 text-[0.6875rem] font-medium text-neutral-600">{client.label}</div>
              <h3 className="text-base font-semibold tracking-tight text-neutral-950">{client.title}</h3>
...
function StudioPricing() {
  return (
    <section className="border-t border-neutral-950/6 py-20">
      <div className={containerClass}>
        <div>
          <h2 className="max-w-[35ch] text-balance text-3xl font-medium tracking-tight text-neutral-950">料金表</h2>
          <p className="mt-2 max-w-[56ch] text-pretty text-[0.9375rem] text-neutral-600">価格は全て税抜きです。最低契約期間は3ヶ月、毎月最低稼動時間は100時間です。</p>
        </div>
        <div className="mt-10 grid overflow-hidden rounded-2xl border border-neutral-950/6 bg-neutral-950/6 lg:grid-cols-3 lg:gap-px">
          {studioPricing.map((tier) => (
            <article key={tier.name} className={`flex flex-col bg-white p-7 ${tier.featured ? 'lg:bg-neutral-50' : ''} ${tier.unavailable ? 'opacity-55' : ''}`}>
              {tier.unavailable ? <div className="mb-3 inline-flex w-fit rounded-full bg-neutral-100 px-2.5 py-1 text-[0.6875rem] font-medium text-neutral-600">現在募集停止中</div> : null}
              <h3 className="text-base font-semibold tracking-tight text-neutral-950">{tier.name}</h3>
              ...
              <div className="mt-3 tabular-nums text-3xl font-semibold tracking-tight text-neutral-950">
                {tier.price}
                {tier.period ? <span className="text-[0.8125rem] font-normal text-neutral-500">{tier.period}</span> : null}
              </div>
              ...
              {tier.unavailableNote ? <p className="mt-3 text-pretty text-[0.8125rem] italic text-neutral-500">{tier.unavailableNote}</p> : null}
              <a href={formUrl} target="_blank" rel="noopener noreferrer" className={`${secondaryButtonClass} mt-5 w-full`}>
                {tier.unavailable ? 'ご相談はこちら' : tier.name === 'オーダーメイド' ? 'お問い合わせ' : '申し込む'}
              </a>
            </article>
          ))}
        </div>
    ...
    <>
      <section className="py-16 sm:pt-28">
        <div className={containerClass}>
          ...
          <h1 className="text-balance text-4xl font-medium tracking-tight text-neutral-950">代表挨拶</h1>
          <p className="mt-3 max-w-[48ch] text-pretty text-[1.0625rem] text-neutral-600">アプリ開発を通じて、よりよい世界を創る。</p>
          <div className="mt-8 max-w-2xl space-y-5 text-pretty text-base/8 text-neutral-700">
            ...
            <p>国際基督教大学（ICU）を卒業後、2019年8月にゲーマー向けマッチングアプリの共同創業者兼CTOとしてアプリ開発のキャリアをスタートしました。VCからの資金調達を経て約3年間プロダクト開発に携わった後、いくつかのプロジェクトを経験し、日本IBMに入社。大手銀行や大手海運企業のアプリ開発に従事しました。</p>
            <p>これらの経験と並行して、Flutterコミュニティでも積極的に活動してきました。FlutterCon（ドイツ・ベルリン）、Flutter Connection（フランス・パリ）、FlutterFormosa（台湾・台北）、State of Open Con（イギリス・ロンドン）での登壇のほか、Google公認のFlutterミートアップ「Flutter Tokyo」のオーガナイザー、日本最大級のFlutterカンファレンス「FlutterKaigi」の運営メンバーとしても活動しています。</p>
            <p>こうした開発の現場での経験を通じて、既存のCI/CDサービスに大きな課題があることを実感しました。使いづらさと高額な料金により、多くのプロジェクトがCI/CDを十分に活用できていません。誰もが使いやすいCI/CDを届けたい。その想いからIBMを退職し、OpenCI株式会社を設立しました。</p>
            <p>
              OpenCIでは、OSSとしてCI/CDプラットフォームを開発しています。すべての開発者が効率的に開発できる環境を提供することが私たちの目標です。
              <br />
              ご興味のある方は、
              <a href={githubUrl} target="_blank" rel="noopener noreferrer" className="border-b border-neutral-950/25 text-neutral-950 transition-colors hover:border-neutral-950">
                OpenCIのGitHub
              </a>
              をご覧ください。
            </p>
            <p>また、OpenCI Studio（以下Studio）では、これまで培ってきたFlutter開発の技術と経験を活かし、技術支援サービスを提供しています。小規模なプロジェクトから大規模なエンタープライズアプリまで幅広くサポートいたします。</p>
            <p>Studioでは単なる技術支援にとどまらず、CTOとしての経験、スタートアップでの事業立ち上げ、大企業でのプロジェクト推進の知見を総合的に活かし、お客様のビジネスをサポートします。技術的な課題解決はもちろん、チーム体制の構築や開発プロセスの改善まで、ビジネスの成功に必要なあらゆる面でお手伝いいたします。</p>
          </div>
        </div>
      </section>
    ...
    <footer className="border-t border-neutral-950/6 py-10">
      <div className={containerClass}>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-4 border-t border-neutral-950/6 pt-7">
          <a href="/studio/" className="text-lg font-semibold tracking-tight text-neutral-950" aria-label="Homepage">
            OpenCI Studio
          </a>
          <p className="text-[0.8125rem] text-neutral-400">© OpenCI株式会社 {new Date().getFullYear()}</p>
        </div>
      </div>
    </footer>
  );
    ...
    <div>
      ...
      <ul role="list" className="space-y-1.5">
        {links.map((link) => {
          ...
          return (
            <li key={link.href}>
              <a href={link.href} target={external ? '_blank' : undefined} rel={external ? 'noopener noreferrer' : undefined} className="text-sm font-normal text-neutral-500 transition-colors hover:text-neutral-950">
                {link.label}
              </a>
            </li>
          );
...
function SectionIntro({ eyebrow, title, children }: { eyebrow: string; title: string; children: ReactNode }) {
  return (
    <div>
      ...
      <h2 className="max-w-[35ch] text-balance text-3xl font-medium tracking-tight text-neutral-950">{title}</h2>
...
function CheckIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" className="relative top-0.5 size-5 shrink-0 text-green-600 sm:size-4">
...
function GiftIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.5" stroke="currentColor" aria-hidden="true" className="size-7 sm:size-6">
...
function VideoIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.5" stroke="currentColor" aria-hidden="true" className="size-8 sm:size-7">
