...
@override
String toString() {
  return 'CreateWorkflowState(isCreated: $isCreated, selectedRepository: $selectedRepository, selectedWorkingDirectory: $selectedWorkingDirectory, selectedTriggerType: $selectedTriggerType, selectedTriggerBranch: $selectedTriggerBranch)';
}
...
class _CreateWorkflowState implements CreateWorkflowState {
  const _CreateWorkflowState({required this.isCreated, required this.selectedRepository, required this.selectedWorkingDirectory, required this.selectedTriggerType, required this.selectedTriggerBranch});
