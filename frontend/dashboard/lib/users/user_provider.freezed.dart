...
mixin _$OpenCIUser {
 ...
 String get id; String get selectedTeamId;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OpenCIUser&&(identical(other.id, id) || other.id == id)&&(identical(other.selectedTeamId, selectedTeamId) || other.selectedTeamId == selectedTeamId));
}
...
/// Create a copy of OpenCIUser
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? selectedTeamId = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String selectedTeamId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OpenCIUser() when $default != null:
return $default(_that.id,_that.selectedTeamId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String selectedTeamId)  $default,) {final _that = this;
switch (_that) {
case _OpenCIUser():
return $default(_that.id,_that.selectedTeamId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String selectedTeamId)?  $default,) {final _that = this;
switch (_that) {
case _OpenCIUser() when $default != null:
return $default(_that.id,_that.selectedTeamId);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OpenCIUser&&(identical(other.id, id) || other.id == id)&&(identical(other.selectedTeamId, selectedTeamId) || other.selectedTeamId == selectedTeamId));
}
...
/// Create a copy of OpenCIUser
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? selectedTeamId = null,}) {
