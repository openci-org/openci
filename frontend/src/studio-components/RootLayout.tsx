...
import { GridPattern } from '@/studio-components/GridPattern'
import { Logo } from '@/studio-components/Logo'
import { Offices } from '@/studio-components/Offices'
import { SocialMedia } from '@/studio-components/SocialMedia'
...
function Navigation() {
  return (
    <nav className="font-display mt-px text-5xl font-medium tracking-tight text-white">
      <NavigationRow>
        {/* <NavigationItem href="/studio/work">Our Work</NavigationItem> */}
        <NavigationItem href="/studio/about">会社概要</NavigationItem>
      </NavigationRow>
      {/* <NavigationRow>
        <NavigationItem href="/studio/process">Our Process</NavigationItem>
        <NavigationItem href="/studio/blog">Blog</NavigationItem>
      </NavigationRow> */}
    </nav>
  )
}
