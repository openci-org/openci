...
abstract class NullableRepository with _$NullableRepository {
  const factory NullableRepository({
    ...
    required NullableLicenseSimple? license,
    required int forks,
    ...
    @JsonKey(name: 'has_pull_requests')
    @Default(true)
  ...
  factory NullableRepository.fromJson(Map<String, Object?> json) => _$NullableRepositoryFromJson(json);
}
