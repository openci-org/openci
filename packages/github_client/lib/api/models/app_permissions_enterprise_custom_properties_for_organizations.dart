...
enum AppPermissionsEnterpriseCustomPropertiesForOrganizations {
  ...
  factory AppPermissionsEnterpriseCustomPropertiesForOrganizations.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<AppPermissionsEnterpriseCustomPropertiesForOrganizations> get $valuesDefined => values.where((value) => value != $unknown).toList();
}
