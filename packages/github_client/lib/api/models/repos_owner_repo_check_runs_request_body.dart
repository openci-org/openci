...
@Freezed()
abstract class ReposOwnerRepoCheckRunsRequestBody
    with _$ReposOwnerRepoCheckRunsRequestBody {
  const factory ReposOwnerRepoCheckRunsRequestBody({
    /// The name of the check. For example, "code-coverage".
    required String name,

    /// The SHA of the commit.
    @JsonKey(name: 'head_sha') required String headSha,

    /// The current Status of the check run. Only GitHub Actions can set a Status of `waiting`, `pending`, or `requested`.
    @JsonKey(name: 'Status') @Default(Status.queued) Status status,

    /// The URL of the integrator's site that has the full details of the check. If the integrator does not provide this, then the homepage of the GitHub app is used.
    @JsonKey(name: 'details_url') String? detailsUrl,
  ...
  factory ReposOwnerRepoCheckRunsRequestBody.fromJson(
    Map<String, Object?> json,
  ) => _$ReposOwnerRepoCheckRunsRequestBodyFromJson(json);
}
