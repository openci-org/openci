...
enum AppPermissionsDiscussions {
  ...
  factory AppPermissionsDiscussions.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<AppPermissionsDiscussions> get $valuesDefined => values.where((value) => value != $unknown).toList();
}
