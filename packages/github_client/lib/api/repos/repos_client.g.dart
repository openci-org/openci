...
class _ReposClient implements ReposClient {
  ...
  Future<FullRepository> reposGet({
    ...
    final _options = _setStreamType<FullRepository>(
    ...
    late FullRepository _value;
    try {
      _value = FullRepository.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<FullRepository> reposUpdate({
    required String owner,
    required String repo,
    ReposOwnerRepoRequestBody? body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<Commit> reposGetCommit({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Commit>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    late Commit _value;
    try {
      _value = Commit.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
