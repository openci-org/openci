...
id  _AppleVirtualization_protocolTrampoline_xr62hr(id target, void * sel, id arg1) {
...
__attribute__((visibility("default"))) __attribute__((used))
BOOL  _AppleVirtualization_protocolTrampoline_e3qsqz(id target, void * sel) {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _AppleVirtualization_wrapListenerBlock_18v1jvf(_ListenerTrampoline block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _AppleVirtualization_wrapBlockingBlock_18v1jvf(
...
__attribute__((visibility("default"))) __attribute__((used))
void  _AppleVirtualization_protocolTrampoline_18v1jvf(id target, void * sel, id arg1) {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _AppleVirtualization_wrapListenerBlock_xtuoz7(_ListenerTrampoline_1 block) NS_RETURNS_RETAINED {
  return ^void(id arg0) {
    objc_retainBlock(block);
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _AppleVirtualization_wrapBlockingBlock_xtuoz7(
...
__attribute__((visibility("default"))) __attribute__((used))
id  _AppleVirtualization_protocolTrampoline_1mbt9g9(id target, void * sel) {
...
__attribute__((visibility("default"))) __attribute__((used))
id  _AppleVirtualization_protocolTrampoline_10z9f5k(id target, void * sel, id arg1, id arg2, id * arg3) {
...
typedef NSItemProviderRepresentationVisibility  (^_ProtocolTrampoline_5)(void * sel, id arg1);
__attribute__((visibility("default"))) __attribute__((used))
NSItemProviderRepresentationVisibility  _AppleVirtualization_protocolTrampoline_1ldqghh(id target, void * sel, id arg1) {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_2 _AppleVirtualization_wrapListenerBlock_pfv6jd(_ListenerTrampoline_2 block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_2 _AppleVirtualization_wrapBlockingBlock_pfv6jd(
...
__attribute__((visibility("default"))) __attribute__((used))
id  _AppleVirtualization_protocolTrampoline_1q0i84(id target, void * sel, id arg1, id arg2) {
...
typedef NSPasteboardWritingOptions  (^_ProtocolTrampoline_7)(void * sel, id arg1, id arg2);
__attribute__((visibility("default"))) __attribute__((used))
NSPasteboardWritingOptions  _AppleVirtualization_protocolTrampoline_zs9fen(id target, void * sel, id arg1, id arg2) {
...
typedef NSPasteboardReadingOptions  (^_ProtocolTrampoline_8)(void * sel, id arg1, id arg2);
__attribute__((visibility("default"))) __attribute__((used))
NSPasteboardReadingOptions  _AppleVirtualization_protocolTrampoline_1jypdhr(id target, void * sel, id arg1, id arg2) {
...
__attribute__((visibility("default"))) __attribute__((used))
id  _AppleVirtualization_protocolTrampoline_zi5eed(id target, void * sel, id arg1, id arg2) {
...
dispatch_queue_t hook_dispatch_get_main_queue(void) {
    if (dummy_main_queue == NULL) {
        dummy_main_queue = dispatch_queue_create("com.apple.main-thread-fake", DISPATCH_QUEUE_SERIAL);
    }
