...
mixin _$BuildJob {
 ...
 String get id; String get status; String get owner; String get repo; String? get teamId; String? get workflowId; String? get workflowFileName; String? get installationToken; String? get commitSha; int? get pullRequestNumber; int? get runCount; String? get latestRunId; String? get tagName; String? get branch; String? get jobKey; String? get workflowRunId; List<String>? get needs; String? get githubBaseUrl; String? get githubApiBaseUrl;@DateTimeConverter() DateTime? get createdAt;@DateTimeConverter() DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,owner,repo,teamId,workflowId,workflowFileName,installationToken,commitSha,pullRequestNumber,runCount,latestRunId,tagName,branch,jobKey,workflowRunId,const DeepCollectionEquality().hash(needs),githubBaseUrl,githubApiBaseUrl,createdAt,updatedAt]);

@override
String toString() {
  return 'BuildJob(id: $id, status: $status, owner: $owner, repo: $repo, teamId: $teamId, workflowId: $workflowId, workflowFileName: $workflowFileName, installationToken: $installationToken, commitSha: $commitSha, pullRequestNumber: $pullRequestNumber, runCount: $runCount, latestRunId: $latestRunId, tagName: $tagName, branch: $branch, jobKey: $jobKey, workflowRunId: $workflowRunId, needs: $needs, githubBaseUrl: $githubBaseUrl, githubApiBaseUrl: $githubApiBaseUrl, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
/// Create a copy of BuildJob
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? status = null,Object? owner = null,Object? repo = null,Object? teamId = freezed,Object? workflowId = freezed,Object? workflowFileName = freezed,Object? installationToken = freezed,Object? commitSha = freezed,Object? pullRequestNumber = freezed,Object? runCount = freezed,Object? latestRunId = freezed,Object? tagName = freezed,Object? branch = freezed,Object? jobKey = freezed,Object? workflowRunId = freezed,Object? needs = freezed,Object? githubBaseUrl = freezed,Object? githubApiBaseUrl = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
as String?,installationToken: freezed == installationToken ? _self.installationToken : installationToken // ignore: cast_nullable_to_non_nullable
...
as List<String>?,githubBaseUrl: freezed == githubBaseUrl ? _self.githubBaseUrl : githubBaseUrl // ignore: cast_nullable_to_non_nullable
...
@override final  String? installationToken;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,owner,repo,teamId,workflowId,workflowFileName,installationToken,commitSha,pullRequestNumber,runCount,latestRunId,tagName,branch,jobKey,workflowRunId,const DeepCollectionEquality().hash(_needs),githubBaseUrl,githubApiBaseUrl,createdAt,updatedAt]);
