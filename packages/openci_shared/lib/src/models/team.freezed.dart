...
mixin _$Team {
 ...
 String get id; String get name; List<String> get members; List<int> get installationIds; int get runNumber; bool get aiEnabled; String? get githubBaseUrl;@DateTimeConverter() DateTime get createdAt;@DateTimeConverter() DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,const DeepCollectionEquality().hash(members),const DeepCollectionEquality().hash(installationIds),runNumber,aiEnabled,githubBaseUrl,createdAt,updatedAt);

@override
String toString() {
  return 'Team(id: $id, name: $name, members: $members, installationIds: $installationIds, runNumber: $runNumber, aiEnabled: $aiEnabled, githubBaseUrl: $githubBaseUrl, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, List<String> members, List<int> installationIds, int runNumber, bool aiEnabled, String? githubBaseUrl,@DateTimeConverter() DateTime createdAt,@DateTimeConverter() DateTime updatedAt
});
...
/// Create a copy of Team
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? members = null,Object? installationIds = null,Object? runNumber = null,Object? aiEnabled = null,Object? githubBaseUrl = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
switch (_that) {
case _Team() when $default != null:
return $default(_that.id,_that.name,_that.members,_that.installationIds,_that.runNumber,_that.aiEnabled,_that.githubBaseUrl,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  List<String> members,  List<int> installationIds,  int runNumber,  bool aiEnabled,  String? githubBaseUrl, @DateTimeConverter()  DateTime createdAt, @DateTimeConverter()  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Team():
return $default(_that.id,_that.name,_that.members,_that.installationIds,_that.runNumber,_that.aiEnabled,_that.githubBaseUrl,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  List<String> members,  List<int> installationIds,  int runNumber,  bool aiEnabled,  String? githubBaseUrl, @DateTimeConverter()  DateTime createdAt, @DateTimeConverter()  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Team() when $default != null:
return $default(_that.id,_that.name,_that.members,_that.installationIds,_that.runNumber,_that.aiEnabled,_that.githubBaseUrl,_that.createdAt,_that.updatedAt);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,const DeepCollectionEquality().hash(_members),const DeepCollectionEquality().hash(_installationIds),runNumber,aiEnabled,githubBaseUrl,createdAt,updatedAt);
...
/// Create a copy of Team
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? members = null,Object? installationIds = null,Object? runNumber = null,Object? aiEnabled = null,Object? githubBaseUrl = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_Team(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
