...
@useResult
$Res call({
 String id, BuildJobStatus status, String owner, String repo, String workflowName, String? teamId, String? workflowId, String? workflowFileName, String? commitSha, int? pullRequestNumber, int? runCount, String? latestRunId, String? tagName, String? branch, String? jobKey, String? workflowJobKey, Map<String, Object?>? matrix, String? matrixLabel, String? workflowRunId, List<String>? needs, String? failureSummary, String? failureSummaryModel, String? failureSummaryStatus, int? failureSummaryDurationMs, List<String>? provisionedUdids, String? ipaUrl, bool? hasIpa, String? bundleId, String? ipaVersion, String? appName,@DateTimeConverter() DateTime? otaDownloadedAt,@DateTimeConverter() DateTime createdAt,@DateTimeConverter() DateTime updatedAt,@DateTimeConverter() DateTime? completedAt
});
...
as String?,otaDownloadedAt: freezed == otaDownloadedAt ? _self.otaDownloadedAt : otaDownloadedAt // ignore: cast_nullable_to_non_nullable
...
@override@DateTimeConverter() final  DateTime? otaDownloadedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,owner,repo,workflowName,teamId,workflowId,workflowFileName,commitSha,pullRequestNumber,runCount,latestRunId,tagName,branch,jobKey,workflowJobKey,const DeepCollectionEquality().hash(_matrix),matrixLabel,workflowRunId,const DeepCollectionEquality().hash(_needs),failureSummary,failureSummaryModel,failureSummaryStatus,failureSummaryDurationMs,const DeepCollectionEquality().hash(_provisionedUdids),ipaUrl,hasIpa,bundleId,ipaVersion,appName,otaDownloadedAt,createdAt,updatedAt,completedAt]);
