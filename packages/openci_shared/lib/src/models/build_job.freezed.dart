...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,owner,repo,workflowName,teamId,workflowId,workflowFileName,commitSha,commitMessage,pullRequestNumber,runCount,latestRunId,tagName,branch,jobKey,workflowJobKey,const DeepCollectionEquality().hash(_matrix),matrixLabel,workflowRunId,const DeepCollectionEquality().hash(_needs),runsOn,failureSummary,failureSummaryModel,failureSummaryStatus,failureSummaryDurationMs,const DeepCollectionEquality().hash(_provisionedUdids),ipaUrl,hasIpa,bundleId,ipaVersion,appName,githubBaseUrl,createdAt,updatedAt,completedAt]);
